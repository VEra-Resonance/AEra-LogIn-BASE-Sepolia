# 🤝 Contributing to AEraLogin

First off, thank you for considering contributing to **AEraLogin**! It's people like you that make this project a reality.
...
def verify_signature(address: str, message: str, signature: str) -> bool:
    ...
    Example:
        >>> verify_signature("0xabc...", "Login to AEra", "0x123...")
        True
    """
```
...
**Thank you for contributing to AEraLogin!** 🎉
